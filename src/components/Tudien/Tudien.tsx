...
const Tudien = () => {
  return (
    <div
      ...
      className="h-screen w-[100%] overflow-x-hidden mt-10 lg:mt-0 z-2 relative flex flex-col justify-center lg:flex-row items-center bg-contain lg:bg-top lg:bg-cover duration-500 ease-in"
    >
